<template>
    <page-view>
        ...
        <div class="content-box flex-1 overflow-auto">
            ...
            <div class="mx-[10px] my-[15px] rounded-[5px] cursor-pointer active:bg-successColor bg-primaryColor text-center text-white h-[25px]">抢票订购</div>   
            <p class="movie-desc">
...
const queryData = ()=>{
    API.movieInfo.getMovieById(route.query.id).then((result)=>{
